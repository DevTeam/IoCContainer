...
namespace IoC.Tests.UsageScenarios
{
    ...
    public class ThreadSingletonLifetime
    {
        ...
        // $header=Sometimes it is useful to have the singleton per a thread lifetime (or more generally a singleton per something else). There is no special "lifetime" type in this framework to achieve this requirement, but it is quite easy create your own "lifetime" type for that.
        // {
        public void Run()
        {
