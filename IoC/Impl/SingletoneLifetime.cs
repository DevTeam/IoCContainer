namespace IoC.Impl
{
    ...
    internal class SingletoneLifetime: SingletoneBaseLifetime
    {
        ...
        {
            return (context.RegistrationContainer as IInstanceStore ?? throw new NotSupportedException($"The lifetime \"{GetType().Name}\" is not supported for specified this container")).GetInstances();
        }
